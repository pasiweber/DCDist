...
if __name__ == '__main__': 
    ...
    #HDBSCAN*
    hdbscan_nary2 = HDBSCANnary(min_pts=min_pts, min_cluster_size=mcs, allow_single_cluster=False)
    hdbscan_nary2.fit(points, objective="simple")
    hdb_labels2 = hdbscan_nary2.labels_
    ...
    #plot_tree_v2(n_root, extra_annotations=hdbscan_nary.extra_annotations)
    ...
    plot_embedding(
        points,
        [hdb_labels, hdb_labels2],
        ['Dataset with ' + str(len(ground_truth_labels)) + ' points and ' + str(k) + " clusters", "simple"],
        centers=None,

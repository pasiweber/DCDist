...
void test_mlpack(){
    arma::mat data3 = { {0.0, 1.0, 20.0, 0.0, 1.0, 20.0, 0.0, 1.0, 20.0, 0.0, 1.0, 20.0, 0.0, 1.0, 20.0, 0.0, 1.0, 20.0, 0.0, 1.0, 20.0, 0.0, 1.0, 20.0},
                        ...
                        // {1.1, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0},
                        // {1.2, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0},
                        // {1.3, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0},
                        // {1.4, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0},
                        // {1.5, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0},
                        // {1.6, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0},
                        // {1.7, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0},
                        // {1.8, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0},
                        // {1.9, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0},
                        // {1.10, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0},
                        // {1.11, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0},


                        // {2.1, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0},
                        // {2.2, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0},
                        // {2.3, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0},
                        // {2.4, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0},
                        // {2.5, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0},
                        // {2.6, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0},
                        // {2.7, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0},
                        // {2.8, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0},
                        // {2.9, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0},
                        // {2.10, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0},
                        // {2.11, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0},



                        // {3.1, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0},
                        // {3.2, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0},
                        // {3.3, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0},
                        // {3.4, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0},
                        // {3.5, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0},
                        // {3.6, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0},
                        // {3.7, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0},
                        // {3.8, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0},
                        // {3.9, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0},
                        // {3.10, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0},
                        // {3.11, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0},


                        // {4.1, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0},
                        // {4.2, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0},
                        // {4.3, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0},
                        // {4.4, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0},
                        // {4.5, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0},
                        // {4.6, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0},
                        // {4.7, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0},
                        // {4.8, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0},
                        // {4.9, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0},
                        // {4.10, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0},
                        // {4.11, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0},

                        // {4.1, 2.0, 35.0, 0.0, 2.0, 35.0, 1.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 250.0, 2.0, 35.0, 0.0, 2.0, 35.0},
                        // {4.2, 3.0, 30.0, 0.0, 3.0, 30.0, 1.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 250.0, 3.0, 30.0, 0.0, 3.0, 30.0},
                        // {4.3, 1.5, 30.0, 0.0, 1.5, 30.0, 1.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 250.0, 1.5, 30.0, 0.0, 1.5, 30.0},
                        // {4.4, 5.5, 11.0, 0.0, 5.5, 11.0, 1.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 250.0, 5.5, 11.0, 0.0, 5.5, 11.0},
                        // {4.5, 10.0,28.0, 0.0, 10.0,28.0, 1.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 250.0, 10.0,28.0, 0.0, 10.0,28.0},
                        // {4.6, 2.0, 30.0, 0.0, 2.0, 30.0, 1.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 250.0, 2.0, 30.0, 0.0, 2.0, 30.0},
                        // {4.7, 7.5, 11.0, 0.0, 7.5, 11.0, 1.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 250.0, 7.5, 11.0, 0.0, 7.5, 11.0},
                        // {4.8, 12.0,28.0, 0.0, 12.0,28.0, 1.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 250.0, 12.0,28.0, 0.0, 12.0,28.0},
                        // {4.9, 4.5, 30.0, 0.0, 4.5, 30.0, 1.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 250.0, 4.5, 30.0, 0.0, 4.5, 30.0},
                        // {4.10, 5.5, 21.0,0.0, 5.5, 21.0, 1.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 250.0, 5.5, 21.0, 0.0, 5.5, 21.0},
                        // {4.11, 11.0,28.0,0.5, 11.0,28.0, 1.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 250.5, 11.0,28.0, 0.5, 11.0,28.0},

                        // {4.1, 2.0, 35.0, 4.0, 2.0, 35.0, 1.0, 2.0, 35.0, 1000.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0, 0.0, 2.0, 35.0},
                        // {4.2, 3.0, 30.0, 4.0, 3.0, 30.0, 1.0, 3.0, 30.0, 1000.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0, 0.0, 3.0, 30.0},
                        // {4.3, 1.5, 30.0, 4.0, 1.5, 30.0, 1.0, 1.5, 30.0, 1000.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0, 0.0, 1.5, 30.0},
                        // {4.4, 5.5, 11.0, 4.0, 5.5, 11.0, 1.0, 5.5, 11.0, 1000.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0, 0.0, 5.5, 11.0},
                        // {4.5, 10.0,28.0, 4.0, 10.0,28.0, 1.0, 10.0,28.0, 1000.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0, 0.0, 10.0,28.0},
                        // {4.6, 2.0, 30.0, 4.0, 2.0, 30.0, 1.0, 2.0, 30.0, 1000.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0, 0.0, 2.0, 30.0},
                        // {4.7, 7.5, 11.0, 4.0, 7.5, 11.0, 1.0, 7.5, 11.0, 1000.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0, 0.0, 7.5, 11.0},
                        // {4.8, 12.0,28.0, 4.0, 12.0,28.0, 1.0, 12.0,28.0, 1000.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0, 0.0, 12.0,28.0},
                        // {4.9, 4.5, 30.0, 4.0, 4.5, 30.0, 1.0, 4.5, 30.0, 1000.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0, 0.0, 4.5, 30.0},
                        // {4.10, 5.5, 21.0,4.0, 5.5, 21.0, 1.0, 5.5, 21.0, 1000.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0, 0.0, 5.5, 21.0},
                        // {4.11, 11.0,28.0,4.5, 11.0,28.0, 1.5, 11.0,28.0, 1000.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0, 0.5, 11.0,28.0},
                        // //Stop here for issue
